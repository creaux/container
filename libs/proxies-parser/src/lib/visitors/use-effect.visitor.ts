  ...
  CallExpression(path: NodePath<t.CallExpression>) {
    ...
    if (t.isArrowFunctionExpression(firstArg)) {
      if (
        ...
        path.replaceWith(
          t.callExpression(
            t.callExpression(t.identifier('useEffectProxy'), [
        ...
        if (isImportSpecifier(specifier)) {
          ...
          if (isIdentifier(imported)) {
            ...
            if (
              ...
              // This represent useEffect as useEffectProxy
              specifier.local.name = 'useEffectProxy';

              // This represent useEffectProxy as useEffectProxy
              imported.name = 'useEffectProxy';
